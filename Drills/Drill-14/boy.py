...
class WalkingState:
    ...
    def do(boy):
        ...
        # fill here
        boy.x = clamp(int((210 - 0)/(boy.bg.h) * (boy.y)), boy.x, boy.bg.w - int((210 - 0) / (boy.bg.h) * (boy.y)))
...
class Boy:
    ...
    def draw(self):
        ...
        self.font.draw(self.x - self.bg.window_left - 90, self.y - self.bg.window_bottom + 70,
                       '(eat ball count:%5d)' % (self.eat_ball_count), (255, 255, 0))
